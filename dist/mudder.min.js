...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,b){var c=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var d=c.length,f=a.length;b=Math.max(0,Math.min(b|0,c.length));for(var g=0;g<f&&b<d;)if(c[b++]!=a[g++])return!1;return g>=f}},"es6-impl","es3");
...
a.value]})};b.prototype.keys=function(){return e(this,function(a){return a.key})};b.prototype.values=function(){return e(this,function(a){return a.value})};b.prototype.forEach=function(a,b){for(var c=this.entries(),d;!(d=c.next()).done;)d=d.value,a.call(b,d[1],d[0],this)};b.prototype[Symbol.iterator]=b.prototype.entries;var c=function(a,b){var c=b&&typeof b;"object"==c||"function"==c?d.has(b)?c=d.get(b):(c=""+ ++g,d.set(b,c)):c="p_"+b;var e=a.data_[c];if(e&&$jscomp.owns(a.data_,c))for(a=0;a<e.length;a++){var f=
e[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:c,list:e,index:a,entry:f}}return{id:c,list:e,index:-1,entry:void 0}},e=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},f=function(){var a={};return a.previous=a.next=a.head=a},g=0;return b},"es6-impl","es3");
...
(function(a){"object"===typeof exports&&"undefined"!==typeof module?module.exports=a():"function"===typeof define&&define.amd?define([],a):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).mudder=a()})(function(){return function(){function a(d,b,c){function e(g,l){if(!b[g]){if(!d[g]){var k="function"==typeof require&&require;if(!l&&k)return k(g,!0);if(f)return f(g,!0);l=Error("Cannot find module '"+g+"'");throw l.code="MODULE_NOT_FOUND",l;
}l=b[g]={exports:{}};d[g][0].call(l.exports,function(a){return e(d[g][1][a]||a)},l,l.exports,a,d,b,c)}return b[g].exports}for(var f="function"==typeof require&&require,g=0;g<c.length;g++)e(c[g]);return e}return a}()({1:[function(a,d,b){function c(a){for(var b=$jscomp.makeIterator(a),c=b.next();!c.done;c=b.next())for(var c=c.value,h=$jscomp.makeIterator(a),d=h.next();!d.done;d=h.next())if(d=d.value,d!==c&&c.startsWith(d))return!1;return!0}function e(a,b){if("undefined"===typeof this)throw new TypeError("constructor called as a function");
if("string"===typeof a)a=a.split("");else if(!Array.isArray(a))throw new TypeError("symbolsArr must be string or array");if("undefined"===typeof b)b=new Map(a.map(function(a,b){return[a,b]}));else if(b instanceof Object&&!(b instanceof Map))b=new Map(Object.entries(b));else if(!(b instanceof Map))throw new TypeError("symbolsMap can be omitted, a Map, or an Object");for(var d=new Set(b.values()),h=0;h<a.length;h++)if(!d.has(h))throw new RangeError(a.length+" symbols given but "+h+" not found in symbol table");
this.num2sym=a;this.sym2num=b;this.maxBase=this.num2sym.length;this.isPrefixCode=c(a)}function f(a,b,c){return a.reduce(function(a,d){d+=a.rem*c;return{res:a.res.concat(Math.floor(d/b)),rem:d%b,den:b}},{res:[],rem:0,den:b})}function g(a,b,c,d,e){if(a.length!==b.length)throw Error("same length arrays needed");var h=d>=e,n=b.slice();h&&(d-=e);a.reduceRight(function(a,d,m){a=d+b[m]+h;h=a>=c;n[m]=h?a-c:a},null);return{res:n,carry:h,rem:d,den:e}}function k(a,b,c,d){a.length<b.length?a=a.concat(Array(Math.max(0,
b.length-a.length)).fill(0)):b.length<a.length&&(b=b.concat(Array(Math.max(0,a.length-b.length)).fill(0)));a=f(a,d+1,c);b=f(b,d+1,c);for(var h=[a],n=[b],m=2;m<=d;m++)h.push(g(h[m-2].res,a.res,c,a.rem+h[m-2].rem,d+1)),n.push(g(n[m-2].res,b.res,c,b.rem+n[m-2].rem,d+1));h.reverse();return h.map(function(a,b){return g(a.res,n[b].res,c,a.rem+n[b].rem,d+1)})}function l(a,b){for(var c=0;c<b.length;c++)if(b[c]&&a[c]!==b[c])return b.slice(0,c+1);return b}function r(a,b){for(var c=Math.min(a.length,b.length),
d=0;d<c;d++)if(a[d]!==b[d])return a[d]<b[d];return a.length<b.length}function v(a){var b=!r(a[0],a[1]);b&&a.reverse();a=a.slice(1).reduce(function(a,b){return a.concat([l(a[a.length-1],b)])},[a[0]]);b&&a.reverse();return a}function t(a,b){var c=a>b;c&&(b=$jscomp.makeIterator([b,a]),a=b.next().value,b=b.next().value);return c?[b,a]:[a,b]}function p(a){return Array.from(Array(a),function(a,b){return b})}function u(a,b){return Array.from(Array(a.length),function(c,d){return[a[d],b[d]]})}c=function(a){a=
Array.from(a).sort();for(var b=$jscomp.makeIterator(a.entries()),c=b.next();!c.done;c=b.next()){var d=$jscomp.makeIterator(c.value),c=d.next().value,d=d.next().value,c=a[c-1];if(c!==d&&d.startsWith(c))return!1}return!0};e.prototype.numberToDigits=function(a,b){b=b||this.maxBase;for(var c=[];1<=a;)c.push(a%b),a=Math.floor(a/b);return c.length?c.reverse():[0]};e.prototype.digitsToString=function(a){var b=this;return a.map(function(a){return b.num2sym[a]}).join("")};e.prototype.stringToDigits=function(a){var b=
this;if(!this.isPrefixCode&&"string"===typeof a)throw new TypeError("parsing string without prefix code is unsupported. Pass in array of stringy symbols?");if("string"===typeof a){var c=new RegExp("("+Array.from(this.sym2num.keys()).join("|")+")","g");a=a.match(c)}return a.map(function(a){return b.sym2num.get(a)})};e.prototype.digitsToNumber=function(a,b){b=b||this.maxBase;var c=1;return a.reduceRight(function(a,d){a+=d*c;c*=b;return a},0)};e.prototype.numberToString=function(a,b){return this.digitsToString(this.numberToDigits(a,
b))};e.prototype.stringToNumber=function(a,b){return this.digitsToNumber(this.stringToDigits(a),b)};e.prototype.roundFraction=function(a,b,c){c=c||this.maxBase;var d=Math.ceil(Math.log(b)/Math.log(c));a=this.numberToDigits(Math.round(a/b*Math.pow(c,d)),c);return Array(Math.max(0,d-a.length)).fill(0).concat(a)};e.prototype.mudder=function(a,b,c,d){var e=this;d=d||this.maxBase;b=$jscomp.makeIterator(t(a,b));a=b.next().value;b=b.next().value;a=this.stringToDigits(a,d);b=this.stringToDigits(b,d);c=k(a,
b,d,c||1).map(function(a){return a.res.concat(e.roundFraction(a.rem,a.den,d))});c.unshift(a);c.push(b);return v(c).slice(1,c.length-1).map(function(a){return e.digitsToString(a)})};b=function(a,b){return Array.from(Array(b),function(b,c){return String.fromCharCode(a.charCodeAt(0)+c)})};a=new e(b("0",10).concat(b("A",26)).concat(b("a",26)));var q=b("0",10).concat(b("a",26)),w=q.concat(b("A",26)),x=p(10).concat(p(26).map(function(a){return a+10})).concat(p(26).map(function(a){return a+10})),q=new e(q,
new Map(u(w,x)));b=new e(b("a",26),new Map(u(b("a",26).concat(b("A",26)),p(26).concat(p(26)))));d.exports={SymbolTable:e,base62:a,base36:q,alphabet:b,longLinspace:k}},{}]},{},[1])(1)});
