...
this.num2sym=a;this.sym2num=b;this.maxBase=this.num2sym.length;this.isPrefixCode=c(a)}function f(a,b,c){return a.reduce(function(a,d){d+=a.rem*c;return{res:a.res.concat(Math.floor(d/b)),rem:d%b,den:b}},{res:[],rem:0,den:b})}function g(a,b,c,d,e){if(a.length!==b.length)throw Error("same length arrays needed");var h=d>=e,m=b.slice();h&&(d-=e);a.reduceRight(function(a,d,n){a=d+b[n]+h;h=a>=c;m[n]=h?a-c:a},null);return{res:m,carry:h,rem:d,den:e}}function k(a,b,c,d){a.length<b.length?a=a.concat(Array(Math.max(0,
b.length-a.length)).fill(0)):b.length<a.length&&(b=b.concat(Array(Math.max(0,a.length-b.length)).fill(0)));if(a.length===b.length&&a.every(function(a,c){return a===b[c]}))throw Error("Start and end strings lexicographically inseparable");a=f(a,d+1,c);for(var h=f(b,d+1,c),m=[a],n=[h],e=2;e<=d;e++)m.push(g(m[e-2].res,a.res,c,a.rem+m[e-2].rem,d+1)),n.push(g(n[e-2].res,h.res,c,h.rem+n[e-2].rem,d+1));m.reverse();return m.map(function(a,b){return g(a.res,n[b].res,c,a.rem+n[b].rem,d+1)})}function l(a,b){for(var c=
0;c<b.length;c++)if(b[c]&&a[c]!==b[c])return b.slice(0,c+1);return b}function r(a,b){for(var c=Math.min(a.length,b.length),d=0;d<c;d++)if(a[d]!==b[d])return a[d]<b[d];return a.length<b.length}function v(a){var b=!r(a[0],a[1]);b&&a.reverse();a=a.slice(1).reduce(function(a,b){return a.concat([l(a[a.length-1],b)])},[a[0]]);b&&a.reverse();return a}function t(a,b){var c=a>b;c&&(b=$jscomp.makeIterator([b,a]),a=b.next().value,b=b.next().value);return c?[b,a]:[a,b]}function p(a){return Array.from(Array(a),
function(a,b){return b})}function u(a,b){return Array.from(Array(a.length),function(c,d){return[a[d],b[d]]})}c=function(a){a=Array.from(a).sort();for(var b=$jscomp.makeIterator(a.entries()),c=b.next();!c.done;c=b.next()){var d=$jscomp.makeIterator(c.value),c=d.next().value,d=d.next().value,c=a[c-1];if(c!==d&&d.startsWith(c))return!1}return!0};e.prototype.numberToDigits=function(a,b){b=b||this.maxBase;for(var c=[];1<=a;)c.push(a%b),a=Math.floor(a/b);return c.length?c.reverse():[0]};e.prototype.digitsToString=
...
var c=1;return a.reduceRight(function(a,d){a+=d*c;c*=b;return a},0)};e.prototype.numberToString=function(a,b){return this.digitsToString(this.numberToDigits(a,b))};e.prototype.stringToNumber=function(a,b){return this.digitsToNumber(this.stringToDigits(a),b)};e.prototype.roundFraction=function(a,b,c){c=c||this.maxBase;var d=Math.ceil(Math.log(b)/Math.log(c));a=this.numberToDigits(Math.round(a/b*Math.pow(c,d)),c);return Array(Math.max(0,d-a.length)).fill(0).concat(a)};e.prototype.mudder=function(a,
b,c,d){var e=this;d=d||this.maxBase;b=$jscomp.makeIterator(t(a,b));a=b.next().value;b=b.next().value;a=this.stringToDigits(a,d);b=this.stringToDigits(b,d);c=k(a,b,d,c||1).map(function(a){return a.res.concat(e.roundFraction(a.rem,a.den,d))});c.unshift(a);c.push(b);return v(c).slice(1,c.length-1).map(function(a){return e.digitsToString(a)})};b=function(a,b){return Array.from(Array(b),function(b,c){return String.fromCharCode(a.charCodeAt(0)+c)})};a=new e(b("0",10).concat(b("A",26)).concat(b("a",26)));
var q=b("0",10).concat(b("a",26)),w=q.concat(b("A",26)),x=p(10).concat(p(26).map(function(a){return a+10})).concat(p(26).map(function(a){return a+10})),q=new e(q,new Map(u(w,x)));b=new e(b("a",26),new Map(u(b("a",26).concat(b("A",26)),p(26).concat(p(26)))));d.exports={SymbolTable:e,base62:a,base36:q,alphabet:b,longLinspace:k}},{}]},{},[1])(1)});
